...
import com.intellij.smalljavaLanguage.smalljava.impl.SmalljavaREFERENCESJSymbolIDImpl;
import com.intellij.util.CharTable;
import com.intellij.util.IncorrectOperationException;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

public class SmalljavaREFERENCESJSymbolIDManipulator extends AbstractElementManipulator<SmalljavaREFERENCESJSymbolIDImpl> {
    @Nullable
    @Override
    public SmalljavaREFERENCESJSymbolIDImpl handleContentChange(@NotNull SmalljavaREFERENCESJSymbolIDImpl element, @NotNull TextRange range, String newContent) throws IncorrectOperationException {
