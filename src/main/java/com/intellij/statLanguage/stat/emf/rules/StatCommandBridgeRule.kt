...
class StatCommandBridgeRule : EmfBridgeRule {
    override fun findLiteralAssignment(pointer: PsiElement): LiteralAssignment? {
        ...
        } else if (pointer.node.elementType == StatTypes.ID_COMMAND_CODE) {
            return object : LiteralAssignment {
                override fun assign(obj: EObject, literal: PsiElement) {
    ...
    override fun createObject(): EObject {
        return statemachine.StatemachineFactory.eINSTANCE.create(statemachine.StatemachinePackage.eINSTANCE.command)
    }
