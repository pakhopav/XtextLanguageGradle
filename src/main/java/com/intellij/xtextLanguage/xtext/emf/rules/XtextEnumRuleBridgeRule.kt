...
class XtextEnumRuleBridgeRule : EmfBridgeRule {
    ...
    override fun findObjectAssignment(pointer: PsiElement): ObjectAssignment? {
        ...
        } else if (pointer is XtextEnumLiterals) {
            return object : ObjectAssignment {
                override fun assign(obj: EObject, toAssign: EObject) {
    ...
    override fun createObject(): EObject {
        return org.xtext.example.xtext.xtext.XtextFactory.eINSTANCE.create(org.xtext.example.xtext.xtext.XtextPackage.eINSTANCE.enumRule)
    }
