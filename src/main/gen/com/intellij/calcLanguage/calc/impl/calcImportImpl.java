...
import static com.intellij.calcLanguage.calc.psi.calcTypes.IMPORT_KEYWORD;

public class calcImportImpl extends calcPsiCompositeElementImpl implements calcImport {

  public calcImportImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public calcREFERENCEModuleID getREFERENCEModuleID() {
    return findNotNullChildByClass(calcREFERENCEModuleID.class);
  }
