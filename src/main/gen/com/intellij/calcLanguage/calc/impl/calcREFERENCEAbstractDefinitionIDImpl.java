...
public class calcREFERENCEAbstractDefinitionIDImpl extends calcPsiCompositeElementImpl implements calcREFERENCEAbstractDefinitionID {

  public calcREFERENCEAbstractDefinitionIDImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull calcVisitor visitor) {
    visitor.visitREFERENCEAbstractDefinitionID(this);
  }
