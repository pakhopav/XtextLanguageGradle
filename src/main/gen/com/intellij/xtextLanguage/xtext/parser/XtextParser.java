...
public class XtextParser implements PsiParser, LightPsiParser {
  ...
  public static boolean EnumLiteralDeclaration(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = REFERENCE_ecoreEEnumLiteral(b, l + 1);
  ...
  public static boolean GeneratedMetamodel(PsiBuilder b, int l) {
    ...
    r = r && ValidID(b, l + 1);
    r = r && REFERENCE_ecoreEPackage_STRING(b, l + 1);
  ...
  static boolean Grammar(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, GrammarID(b, l + 1));
    r = p && report_error_(b, Grammar_2(b, l + 1)) && r;
    r = p && report_error_(b, Grammar_3(b, l + 1)) && r;
    r = p && report_error_(b, Grammar_4(b, l + 1)) && r;
    r = p && Grammar_5(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // ('with' REFERENCE_Grammar_GrammarID/* usedGrammars+=[Grammar|GrammarID]*/ (',' REFERENCE_Grammar_GrammarID)*)?
  ...
  // (REFERENCE_AbstractRule_RuleID/* usedGrammars+=[Grammar|GrammarID]*/ (',' REFERENCE_AbstractRule_RuleID)*)?
  ...
  public static boolean LiteralCondition(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<literal condition>", FALCE, TRUE)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, LITERAL_CONDITION, "<literal condition>");
    r = consumeToken(b, TRUE);
    if (!r) r = consumeToken(b, FALCE);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean Negation(PsiBuilder b, int l) {
    ...
    r = Atom(b, l + 1);
    if (!r) r = Negation_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // '!' Negation
  private static boolean Negation_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Negation_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, ACX_MARK);
    r = r && Negation(b, l + 1);
  ...
  public static boolean ParameterReference(PsiBuilder b, int l) {
    ...
    ParameterReference_0(b, l + 1);
    exit_section_(b, l, m, true, false, null);
    return true;
  }

  // Parameter|ID
  private static boolean ParameterReference_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ParameterReference_0")) return false;
    boolean r;
    r = Parameter(b, l + 1);
  ...
  /* ********************************************************** */
  // ID
  public static boolean REFERENCE_ecoreEClassifier(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "REFERENCE_ecoreEClassifier")) return false;
    if (!nextTokenIs(b, ID)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, ID);
  ...
  /* ********************************************************** */
  // ID
  public static boolean REFERENCE_ecoreEEnumLiteral(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "REFERENCE_ecoreEEnumLiteral")) return false;
    if (!nextTokenIs(b, ID)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, ID);
  ...
  /* ********************************************************** */
  // STRING
  public static boolean REFERENCE_ecoreEPackage_STRING(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "REFERENCE_ecoreEPackage_STRING")) return false;
    if (!nextTokenIs(b, STRING)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, STRING);
  ...
  /* ********************************************************** */
  // (REFERENCE_AbstractMetamodelDeclaration/*metamodel=[AbstractMetamodelDeclaration]*/ '::')? REFERENCE_ecoreEClassifier
  public static boolean TypeRef(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = TypeRef_0(b, l + 1);
    r = r && REFERENCE_ecoreEClassifier(b, l + 1);
    exit_section_(b, m, TYPE_REF, r);
    return r;
  }

  // (REFERENCE_AbstractMetamodelDeclaration/*metamodel=[AbstractMetamodelDeclaration]*/ '::')?
