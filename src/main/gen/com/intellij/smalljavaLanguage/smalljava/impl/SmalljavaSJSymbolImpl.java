...
public abstract class SmalljavaSJSymbolImpl extends SmalljavaNamedElementImpl implements SmalljavaSJSymbol {

    public SmalljavaSJSymbolImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull SmalljavaVisitor visitor) {
        visitor.visitSJSymbol(this);
    }
